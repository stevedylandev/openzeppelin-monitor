...
* For Midnight networks, transaction status monitoring requires a websocket RPC URL (`"type_": "ws_rpc"`) in the network configuration. Without it, transaction status monitoring will be disabled.
